//////////// Standard Header file for the DSPIC33FJ09GS302 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
#device DSPIC33FJ09GS302

#nolist
//////// Program memory: 3064x24  Data RAM: 1024  Stack: 31
//////// I/O: 29   Analog Pins: 8
//////// Fuses: ICSP3,ICSP2,ICSP1,NOJTAG,JTAG,DEBUG,NODEBUG,WPOSTS1,WPOSTS2
//////// Fuses: WPOSTS3,WPOSTS4,WPOSTS5,WPOSTS6,WPOSTS7,WPOSTS8,WPOSTS9
//////// Fuses: WPOSTS10,WPOSTS11,WPOSTS12,WPOSTS13,WPOSTS14,WPOSTS15
//////// Fuses: WPOSTS16,WPRES32,WPRES128,NOPLLWAIT,PLLWAIT,NOWDT,WDT,EC,XT
//////// Fuses: HS,NOPR,OSCIO,NOOSCIO,NOIOL1WAY,IOL1WAY,CKSFSM,CKSNOFSM
//////// Fuses: NOCKSNOFSM,FRC,FRC_PLL,PR,PR_PLL,LPRC,FRC_PS,NOIESO,IESO,WRT
//////// Fuses: NOWRT,PROTECT,NOPROTECT
//////// 
...
#define sAN6                0x0040 //| B1 
#define sAN7                0x0080 //| B2 
...
#define COMP_GAIN            0x0004   // DAC Output scaled by 1.8
#define COMP_HYST_FALLING    0x0010   // Hysteresis is applied to the falling edge of comparator output
...
#define COMP_FILTER_CLK_PWM  0x0200   // Digital filter and pulse stretcher operate with the PWM clock
#define COMP_FILTER_ENABLE   0x0400   // Digital filter is enabled
#define COMP_HALT_IDLE       0x2000
      // OR in one of the following
#define COMP_NO_HYST         0x0000   // No Hysteresis
#define COMP_HYST_15         0x0800   // 15 mV Hysteresis
#define COMP_HYST_30         0x1000   // 30 mV Hysteresis
#define COMP_HYST_45         0x1800   // 45 mV Hysteresis
