//////////// Standard Header file for the PIC16F777 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
_bif void read_external_memory(int16 address, int8 *ptr, int8 count);   
_bif void write_external_memory(int16 address, int8 *ptr, int8 count);  
