//////////// Standard Header file for the PIC18F95J94 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
#nolist
//////// Program memory: 16376x16  Data RAM: 3578  Stack: 31
...
//////// Fuses: CINA_DEFAULT,NOEXTADDRSFT,EXTADDRSFT,ABW20,ABW16,ABW12,ABW8
//////// Fuses: BW8,BW16,WAIT,NOWAIT,NOIOL1WAY,IOL1WAY,LS24MHZ,LS48MHZ
//////// Fuses: MSSP2MSK5,MSSP2MSK7,MSSPMSK5,MSSPMSK7,WDTWIN_75%,WDTWIN_50%
//////// Fuses: WDTWIN_37%,WDTWIN_25%,WDTCLK_PERIPHERAL,WDTCLK_SOSC
//////// Fuses: WDTCLK_LPRC,WDTCLK_FRC,WDT1,WDT2,WDT4,WDT8,WDT16,WDT32,WDT64
//////// Fuses: WDT128,WDT256,WDT512,WDT1024,WDT2048,WDT4096,WDT8192
//////// Fuses: WDT16384,WDT32768,NOWDT,WDT_NOSL,WDT_SW,WDT,NOWINDIS,WINDIS
//////// Fuses: WPRES32,WPRES128,VREGSLEEP_SW,NOVREGSLEEP,NOVBATBOR,VBATBOR
//////// Fuses: NODSBOR,DSBOR,NODS,DS_SW,DSWDT_1MS,DSWDT_2MS,DSWDT_4MS
//////// Fuses: DSWDT_8MS,DSWDT_16MS,DSWDT_33MS,DSWDT_66MS,DSWDT_132MS
//////// Fuses: DSWDT_264MS,DSWDT_528MS,DSWDT_1SEC,DSWDT_2SEC,DSWDT_4SEC
//////// Fuses: DSWDT_8SEC,DSWDT_16SEC
//////// 
...
_bif void set_tris_h(int8 value);  
_bif void set_tris_j(int8 value);  
_bif void set_tris_k(int8 value);  
_bif void set_tris_l(int8 value);  
...
_bif int8 get_tris_h(void);  
_bif int8 get_tris_j(void);  
_bif int8 get_tris_k(void);  
_bif int8 get_tris_l(void);  
...
_bif void output_h(int8 value);  
_bif void output_j(int8 value);  
_bif void output_k(int8 value);  
_bif void output_l(int8 value);  
...
_bif int8 input_h(void);  
_bif int8 input_j(void);  
_bif int8 input_k(void);  
_bif int8 input_l(void);  
...
_bif int1 input_change_h(void);  
_bif int1 input_change_j(void);  
_bif int1 input_change_k(void);  
_bif int1 input_change_l(void);  
...
#define PIN_K0   getenv("SFR:PORTK")*8+0
#define PIN_K1   getenv("SFR:PORTK")*8+1
#define PIN_K2   getenv("SFR:PORTK")*8+2
#define PIN_K3   getenv("SFR:PORTK")*8+3
#define PIN_K4   getenv("SFR:PORTK")*8+4
#define PIN_K5   getenv("SFR:PORTK")*8+5
#define PIN_K6   getenv("SFR:PORTK")*8+6
#define PIN_K7   getenv("SFR:PORTK")*8+7
...
#define CP2_H5_A5       0x00008000  
#define CP2_H4_A5       0x00008100  
#define CP2_F2_A5       0x00008200
#define CP2_VBG_A5      0x00008300
#define CP2_H5_VREF     0x00008400  
#define CP2_H4_VREF     0x00008500  
...
#define DSM_CARRIER_HIGH_REFO1          0x0300  
...
#define sAN6            0x00004000  //| A4
#define sAN7            0x00008000  //| F2
#define sAN8            0x00010000  //| G0
#define sAN9            0x00020000  //| C2
...
#define ALL_ANALOG      0xFFFFFF00  // A0 A1 A2 A3 A5 F7 A4 F2 G0 C2 F5 F6 H4 H5 H6 H7 G4 G3 G2 G1 H3 H2 H1 H0  
...
#define INT_unused                0x00A301
#define INT_unused                0x00A302
...
#define INT_CCP3                  0x00B501
#define INT_CCP4                  0x00B502
#define INT_CCP5                  0x00B504
#define INT_CCP6                  0x00B508
#define INT_CCP7                  0x00B510
#define INT_CCP8                  0x00B520
#define INT_CCP9                  0x00B540
#define INT_CCP10                 0x00B580
