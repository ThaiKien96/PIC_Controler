//////////// Standard Header file for the PIC10LF322 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
#nolist
//////// Program memory: 512x14  Data RAM: 64  Stack: 8
//////// I/O: 4   Analog Pins: 3
...
//////// Fuses: NOLVP,LVP,NOLPBOR,LPBOR,BORV25,BORV19,WRT,WRT_100,WRT_80
...
_bif void set_nco_accumulator(int16 value);
_bif int16 get_nco_accumulator(void);
...
// One of the following may be OR'ed in with the above using |
#define NCO_CLOCK_LC1OUT     0x0300  
#define NCO_CLOCK_HFINOSC    0x0200  
#define NCO_CLOCK_FOSC       0x0100
#define NCO_CLOCK_NCO1CLK    0  
// One of the following may be OR'ed in with the above using |
