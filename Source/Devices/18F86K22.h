//////////// Standard Header file for the PIC18F86K22 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
#nolist
//////// Program memory: 32768x16  Data RAM: 4095  Stack: 31
...
//////// Fuses: RTCOSC_T1,NOEXTADDRSFT,EXTADDRSFT,ABW20,ABW16,ABW12,ABW8,BW8
//////// Fuses: BW16,WAIT,NOWAIT,CCP2E7,CCP2C1,ECCPH,ECCPE,MSSPMSK5,MSSPMSK7
//////// Fuses: NOMCLR,MCLR,NOSTVREN,STVREN,BBSIZ1K,BBSIZ2K,DEBUG,NODEBUG
...
// Timer 7 Prototypes:
_bif void setup_timer_7(int16 mode);
_bif int16 get_timer7(void);
_bif void set_timer7(int16 value);
...
// Timer 10 Prototypes:
_bif void setup_timer_10(int8 mode, int8 period, int8 postscaler);
_bif int8 get_timer10(void);
_bif void set_timer10(int8 value);
...
// Timer 12 Prototypes:
_bif void setup_timer_12(int8 mode, int8 period, int8 postscaler);
_bif int8 get_timer12(void);
_bif void set_timer12(int8 value);
...
// EXT MEM Prototypes:
_bif void setup_external_memory(int8 mode);
_bif void read_external_memory(int32 address, int8 *ptr, int16 count);  
_bif void write_external_memory(int32 address, int8 *ptr, int16 count); 
...
// Use one of the above and optionally OR in one of:
...
_bif void set_adc_channel(int8 pos_channel);
_bif void set_adc_channel(int8 pos_channel, int8 neg_channel);
