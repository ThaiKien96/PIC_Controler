//////////// Standard Header file for the PIC16F707-ICD device ////////////////
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
#device PIC16F707-ICD

#nolist
//////// Program memory: 8192x14  Data RAM: 362  Stack: 8
...
////////////////////////////////////////////////////////////////// Timer A
// Timer A (AKA RTCC)Functions: SETUP_TIMER_A(),SET_TIMERA(),GET_TIMERA()
// Timer A Prototypes:
_bif void setup_timer_a(int8 mode);
_bif void set_timera(int8 value);
_bif int8 get_timera(void);
// Constants used for SETUP_TIMER_A() are:
#define TA_OFF        0
#define TA_INTERNAL   0x80
#define TA_EXT_L_TO_H 32
#define TA_EXT_H_TO_L 48

#define TA_DIV_1      0x88
#define TA_DIV_2      0x80
#define TA_DIV_4      0x81
#define TA_DIV_8      0x82
#define TA_DIV_16     0x83
#define TA_DIV_32     0x84
#define TA_DIV_64     0x85
#define TA_DIV_128    0x86
#define TA_DIV_256    0x87

////////////////////////////////////////////////////////////////// Timer B
// Timer B (AKA RTCC)Functions: SETUP_TIMER_B(),SET_TIMERB(),GET_TIMERB()
// Timer B Prototypes:
_bif void setup_timer_b(int8 mode);
_bif void set_timerb(int8 value);
_bif int8 get_timerb(void);
// Constants used for SETUP_TIMER_B() are:
#define TB_OFF        0
#define TB_INTERNAL   0x80
#define TB_EXT_L_TO_H 32
#define TB_EXT_H_TO_L 48

#define TB_DIV_1      0x88
#define TB_DIV_2      0x80
#define TB_DIV_4      0x81
#define TB_DIV_8      0x82
#define TB_DIV_16     0x83
#define TB_DIV_32     0x84
#define TB_DIV_64     0x85
#define TB_DIV_128    0x86
#define TB_DIV_256    0x87
...
#define INT_TIMERA                0x008D10
#define INT_TIMERB                0x008D20
