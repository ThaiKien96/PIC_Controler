//////////// Standard Header file for the TPIC24FJ64GC010 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
#device TPIC24FJ64GC010

#nolist
//////// Program memory: 22012x24  Data RAM: 8192  Stack: 31
//////// I/O: 88   Analog Pins: 50
...
//////// Fuses: WPOSTS15,WPOSTS16,WDT32,WDT128,NOWINDIS,WINDIS,NOWDT
//////// Fuses: WDT_NOSL,WDT_SW,WDT,ICSP3,ICSP2,ICSP1,LVR,NOLVR,DEBUG
//////// Fuses: NODEBUG,WRT,NOWRT,PROTECT,NOPROTECT,NOJTAG,JTAG,EC,XT,HS
//////// Fuses: NOPR,WDTCLK_SYS,WDTCLK_SOSC,WDTCLK_31KHZ,WDTCLK_LPRC,OSCIO
//////// Fuses: NOOSCIO,CKSFSM,CKSNOFSM,NOCKSNOFSM,FRC,FRC_PLL,PR,PR_PLL
//////// Fuses: SOSC,LPRC,FRC_PS,VREFNORM,VREFALT,CVREFNORM,CVREFALT
//////// Fuses: NOWDTCMX,WDTCMX,NOIESO,IESO,NOWPFP,WPFP,SOSC_DIG,SOSC_SEL
...
//////// Fuses: DSBOR,NODSWDT,DSWDT,NODS,DS_SW,NORTCBAT,RTCBAT,PLL1,PLL2
//////// Fuses: PLL3,PLL4,PLL5,PLL6,PLL8
//////// 
...
#define sAN0      0x0000000000000001 //| B0
#define sAN1      0x0000000000000002 //| B1
#define sAN2      0x0000000000000004 //| B2
#define sAN3      0x0000000000000008 //| B3
#define sAN4      0x0000000000000010 //| B4
#define sAN5      0x0000000000000020 //| B5
#define sAN6      0x0000000000000040 //| B6
#define sAN7      0x0000000000000080 //| B7
#define sAN8      0x0000000000000100 //| C1
#define sAN9      0x0000000000000200 //| C3
#define sAN10      0x0000000000000400 //| F5
#define sAN11      0x0000000000000800 //| F4
#define sAN12      0x0000000000001000 //| B12
#define sAN13      0x0000000000002000 //| B13
#define sAN14      0x0000000000004000 //| B14
#define sAN15      0x0000000000008000 //| B15
#define sAN16      0x0000000000010000 //| C4
#define sAN17      0x0000000000020000 //| G6
#define sAN18      0x0000000000040000 //| G7
#define sAN19      0x0000000000080000 //| G8
#define sAN20      0x0000000000100000 //| D7
#define sAN21      0x0000000000200000 //| E9
#define sAN22      0x0000000000400000 //| A7
#define sAN23      0x0000000000800000 //| A6
#define sAN24      0x0000000001000000 //| D9
#define sAN25      0x0000000002000000 //| D2
#define sAN26      0x0000000004000000 //| A1
#define sAN27      0x0000000008000000 //| F13
#define sAN28      0x0000000010000000 //| D15
#define sAN29      0x0000000020000000 //| D15
#define sAN30      0x0000000040000000 //| F3
#define sAN31      0x0000000080000000 //| F2
#define sAN32      0x0000000100000000 //| F8
#define sAN33      0x0000000200000000 //| G15
#define sAN34      0x0000000400000000 //| D6
#define sAN35      0x0000000800000000 //| D1
#define sAN36      0x0000001000000000 //| A4
#define sAN37      0x0000002000000000 //| A5
#define sAN38      0x0000004000000000 //| A14
#define sAN39      0x0000008000000000 //| A15
#define sAN40      0x0000010000000000 //| D8
#define sAN41      0x0000020000000000 //| D10
#define sAN42      0x0000040000000000 //| D11
#define sAN43      0x0000080000000000 //| D0
#define sAN44      0x0000100000000000 //| D3
#define sAN45      0x0000200000000000 //| D12
#define sAN46      0x0000400000000000 //| D13
#define sAN47      0x0000800000000000 //| D4
#define sAN48      0x0001000000000000 //| D5
#define sAN49      0x0002000000000000 //| G9
...
// One of the following maybe OR'ed in with the above using |
#define VREF_COMP_BGV        0x0100  // Band gap voltage is CVref- reference
#define VREF_COMP_BGV_DIV_2  0x0000  // Band gap voltage divided by two is CVref- reference
...
// LCD Prototypes:
_bif void setup_lcd(unsigned int64 mode, unsigned int8 prescale);
_bif void setup_lcd(unsigned int64 mode, unsigned int8 prescale, unsigned int64 segments);
_bif void lcd_load(unsigned int16 *ptr, unsigned int16 offset, unsigned int16 count);
_bif void lcd_symbol(unsigned int16 symbol, unsigned int16 b1_addr, ...);
...
_bif void setup_dsm(unsigned int16 mode, unsigned int16 source);
_bif void setup_dsm(unsigned int16 mode, unsigned int16 source, unsigned int16 carrier);
...
// DMA Prototypes:
_bif void setup_dma(unsigned int8 channel, unsigned int32 trigger, unsigned int32 mode);
...
#define INT_DAC1                  235
#define INT_DAC2                  236
#define INT_ADCSD                 249
#define INT_FRC                   250
#define INT_LCD                   251
#define INT_OPAMP1                252
#define INT_OPAMP2                253
