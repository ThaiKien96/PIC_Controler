//////////// Standard Header file for the PIC24F16KL402 device ////////////////
///////////////////////////////////////////////////////////////////////////
...
//////// Fuses: LPRC_DIV,FRC,SOSC_DIGITAL,SOSC_ANALOG,LPRCLOW,LPRCHIGH
...
//////// Fuses: BROWNOUT_NOSL,BROWNOUT,NOPUT,PUT,ALTI2C1,NOALTI2C1,LPBORV
...
// Timer 4 Prototypes:
_bif void setup_timer4(unsigned int8 mode, unsigned int8 period, unsigned int8 postscale);
_bif unsigned int8 get_timer4(void);
_bif void set_timer4(unsigned int8 value);
...
// CCP3 Prototypes:
_bif void setup_ccp3(unsigned int32 mode);
_bif void setup_ccp3(unsigned int32 mode, unsigned int8 pwm);
_bif void set_pwm3_duty(unsigned int8 duty);
